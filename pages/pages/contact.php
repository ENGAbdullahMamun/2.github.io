  ...
  <section id="topbar" class="top d-lg-block">
      <div class="clearfix"><center>
        <div class="contact-info d-inline-block">
          <span style="border-right: 2px solid white;padding-right: 18px;"><i class="fa fa-envelope-o"></i> <a href="info@painfreemedspa.com" class="text-white"><b><a href="contact.html" class="text-white numb">Request an Appointment</a></b></a></span>
          <kp class="">
          <i class="fa fa-phone" class="inf"></i><b class="text-white text numb">+918 710 5060</b>
        </kp>
          </div>
    ...
    <div id="" class="pull-left">
        ...
        <nav id="nav-menu-container">
           ...
           <li class="menu-has-children"><a class="numbb" href="">PrimeMed</a>
              ...
              <li class="menu-has-children"><a class="numbb" href="">PrimeSpa</a>
              <ul>
...
<section id="" class="wow fadeInUp" style="margin-button: -5px">
...
<div class="col-lg-4 d-inline-block imm col-md-4 pt-5" >
...
<div class="d-inline-block pt-5 text-white mbdd table-responsive tabbb">
...
<div class="col-lg-4 d-inline-block pt-5 text-white">
<div class="contat">
<strong>Contact</strong><br>
Phone : <b>+918 710 5060</b><br>
Fax : <b>+918 392 4555</b><br>
Email :<b>info@painfreemedspa.com</b><br>
